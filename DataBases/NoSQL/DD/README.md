...
La carpeta `DD` tiene como objetivo almacenar y organizar el diccionario de datos del sistema NoSQL, documentando la estructura, atributos, relaciones y descripción de los datos utilizados dentro del proyecto.
