...
La carpeta `DD` tiene como objetivo almacenar y organizar el diccionario de datos del sistema SQL, documentando atributos, tipos de datos, restricciones y relaciones entre las entidades del sistema.
