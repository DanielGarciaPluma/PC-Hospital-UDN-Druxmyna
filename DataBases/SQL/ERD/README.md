...
La carpeta `ERD` tiene como objetivo almacenar y organizar los diagramas entidad-relación del sistema, representando gráficamente la estructura lógica y las relaciones entre las entidades de la base de datos.
