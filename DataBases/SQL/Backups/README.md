...
La carpeta `Backups` tiene como objetivo almacenar y organizar los respaldos de las bases de datos SQL del proyecto, asegurando la recuperación, integridad y disponibilidad de la información ante posibles fallos.
