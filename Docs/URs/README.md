...
La carpeta `URs` tiene como objetivo almacenar y organizar los requerimientos de usuario del sistema, documentando las necesidades generales, expectativas y objetivos funcionales planteados por los usuarios o clientes del proyecto.
