...
La carpeta `BRs` tiene como objetivo almacenar y organizar las reglas de negocio del sistema, definiendo las políticas, restricciones y lineamientos que rigen el funcionamiento y comportamiento de los procesos del proyecto.
