...
La carpeta `FRs` tiene como objetivo almacenar y organizar los requerimientos funcionales del sistema, describiendo las funcionalidades, procesos y servicios que la aplicación debe cumplir para satisfacer las necesidades del proyecto.
