...
La carpeta `WebApp` tiene como objetivo almacenar y organizar los diseños, prototipos e interfaces gráficas correspondientes a la aplicación web del proyecto.
