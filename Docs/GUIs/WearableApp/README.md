...
La carpeta `WearableApp` tiene como objetivo almacenar y organizar los diseños, prototipos e interfaces gráficas correspondientes a la aplicación para dispositivos wearables del proyecto.
