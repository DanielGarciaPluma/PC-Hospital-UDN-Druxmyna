...
La carpeta `frontend` tiene como objetivo almacenar y organizar los componentes visuales e interfaces de usuario del módulo Wearables, permitiendo la interacción con el sistema mediante pantallas, vistas y recursos gráficos orientados a la experiencia del usuario.
