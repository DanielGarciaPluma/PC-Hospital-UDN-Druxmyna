...
La carpeta `DeployManual` tiene como objetivo almacenar y organizar la documentación relacionada con el despliegue de la aplicación WebApp, incluyendo procedimientos, configuraciones y pasos necesarios para su instalación, ejecución y puesta en funcionamiento.
